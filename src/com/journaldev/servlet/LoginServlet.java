...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Adding logic to handle DB reconnect if the server goes down and comes back.
		try {
			if ( con == null  || !con.isValid(10)) {
				getServletContext().removeAttribute("DBConnection");
				con = DBConnectionManager.getConnection(getServletContext());
				logger.info("connection invalid, created again:"+con); 
			}
